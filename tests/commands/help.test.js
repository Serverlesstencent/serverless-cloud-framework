...
describe('scf --help command: src/commands/help', () => {
  const cli = { logLogo: () => {} };
  beforeAll(() => {
    cli.log = jest.fn();
  });
  ...
  test('scf help in scf component project', async () => {
