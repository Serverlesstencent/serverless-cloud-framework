...
describe('scf init command: src/commands/init', () => {
  let restoreCwd;
  const cli = {
    logLogo: () => {},
    sessionStatus: () => {},
  ...
  test('scf init with name error', async () => {
    try {
      await initCmd({}, cli);
    } catch (e) {
  ...
  test('scf init component project', async () => {
  ...
  test('scf init template project', async () => {
  ...
  test('scf init an empty properties project', async () => {
